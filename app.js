...
{"situacao":"diagnóstico em 1 frase, baseado na conversa real","temperatura":"Frio|Morno|Quente","perfil":"perfil do cliente e motivo","risco":"Baixo|Médio|Alto + motivo","objetivo":"objetivo desta retomada","proximo_passo":"ação específica do corretor","evitar":"erro específico a evitar com este cliente","ultimo_falante":"cliente|corretor|indefinido","ultimo_compromisso_cliente":"o que o cliente disse por último, resumido","informacao_prometida":"o que o corretor prometeu enviar ou fazer","produto_principal":"nome do imóvel/produto discutido","produtos_paralelos":"outros produtos citados, se houver","objecao":"objeção real levantada pelo cliente","pendencia_financeira":"pendência financeira específica, se houver","proxima_acao_de":"cliente|corretor|indefinido","etapa_comercial":"descoberta|interesse|comparação|análise financeira|negociação|decisão","nivel_interesse":"Baixo|Médio|Alto","retomadas":[{"label":"Principal","texto":"mensagem pronta em português, escrita a partir do ponto exato onde a conversa parou","dica":"por que esta abordagem funciona para este cliente"},{"label":"Direta","texto":"mensagem pronta, mais objetiva","dica":"por que esta abordagem funciona para este cliente"},{"label":"Consultiva","texto":"mensagem pronta, mais consultiva","dica":"por que esta abordagem funciona para este cliente"}]}
Regras obrigatórias das mensagens: português brasileiro natural; máximo aproximado de 400 caracteres por opção; sem emojis; apenas uma pergunta principal; não usar “faz sentido”, “fiquei pensando”, “estive pensando”, “ainda tem interesse?” ou retomadas genéricas; usar a pendência real como gancho; não pressionar; não dar saída fácil; manter o produto principal e só depois abrir alternativas; não inventar dados. Nunca copie literalmente os textos de exemplo acima (como "curta", "curto" ou os nomes dos campos) — eles descrevem o formato esperado, não o conteúdo da resposta; substitua sempre por texto real extraído da conversa.`:
...
Responda APENAS JSON válido:
{"situacao":"diagnóstico em 1 frase, baseado na conversa real","temperatura":"Frio|Morno|Quente","perfil":"perfil e motivo","risco":"Baixo|Médio|Alto + motivo","objetivo":"objetivo imediato","proximo_passo":"ação específica","evitar":"erro a evitar","ultimo_falante":"cliente|corretor|indefinido","ultimo_compromisso_cliente":"o que o cliente disse por último, resumido","informacao_prometida":"o que o corretor prometeu enviar ou fazer","produto_principal":"nome do imóvel/produto discutido","produtos_paralelos":"outros produtos citados, se houver","objecao":"objeção real levantada pelo cliente","pendencia_financeira":"pendência financeira específica, se houver","proxima_acao_de":"cliente|corretor|indefinido","etapa_comercial":"descoberta|interesse|comparação|análise financeira|negociação|decisão","nivel_interesse":"Baixo|Médio|Alto","respostas":[]}
Regras: português brasileiro, direto, sem inventar dados, sem usar “faz sentido”, sem generalidades. Nunca copie literalmente os textos de exemplo acima — eles descrevem o formato esperado, não o conteúdo da resposta; substitua sempre por texto real extraído da conversa.`;
