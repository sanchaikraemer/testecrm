const CACHE='levecrm-v34';
const CORE=['./','./index.html','./propostas.html','./assets/styles.css','./assets/app.js','./assets/levecrm-logo.png','./manifest.webmanifest','./icon-192.png','./icon-512.png'];
