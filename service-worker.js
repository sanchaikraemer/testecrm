const CACHE='levecrm-v48';
const CORE=[
  './','./index.html','./propostas.html','./styles.css?v=48','./app.js?v=48','./propostas.js?v=48',
  './levecrm-logo.png','./manifest.webmanifest','./icon-192.png','./icon-512.png','./leads-iniciais.json?v=48'
];
