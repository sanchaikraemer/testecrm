const CACHE='levecrm-v54';
const CORE=[
  './','./index.html','./propostas.html','./styles.css?v=54','./app.js?v=54','./propostas.js?v=54',
  './levecrm-logo.png','./manifest.webmanifest','./icon-192.png','./icon-512.png','./leads-iniciais.json?v=54'
];
